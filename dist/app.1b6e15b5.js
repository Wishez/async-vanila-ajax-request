...
require('./app.test');
},{"./app.test":21}],16:[function(require,module,exports) {
'use strict';
...
function ajax(_ref) {
	...
	return new Promise(function (resolve, reject) {
		...
		request.onreadystatechange = function (xhr) {
			...
			var isRequestDone = readyState === 4;
			var isStatusOk = status === 200;
			var isNotFound = status === 404;
...
function makeAjaxForArticlesData() {
	...
	var api = 'https://filipp-zhuravlev.ru/api/v1/';
	var method = "GET";
	var url = api + 'article/';
	...
	request.then(function (data) {
		if (data) {
			var dataHtml = '<p class="content">OK. I have got data!</p>';

			addTo(track, dataHtml);
		}
	}).catch(function (message) {
		var errorHtml = '<p class="color_red">' + message + '</p>';
...
},{"../styles/index.scss":8,"../tests":20}],22:[function(require,module,exports) {
...
//# sourceMappingURL=/app.1b6e15b5.map